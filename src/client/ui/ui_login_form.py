...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.btn_vhod = QtWidgets.QPushButton(parent=self.centralwidget)
        self.btn_vhod.setObjectName("btn_vhod")
        self.horizontalLayout.addWidget(self.btn_vhod)
        ...
        self.L_error = QtWidgets.QLabel(parent=self.centralwidget)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btn_vhod.setText(_translate("MainWindow", "Вход"))
        self.btn_cancel.setText(_translate("MainWindow", "Отмена"))
        self.L_error.setText(_translate("MainWindow", "Неверный логин/пароли или пользователя нет в базе."))
